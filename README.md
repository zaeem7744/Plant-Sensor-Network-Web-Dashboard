...
Real-time web dashboard for the Plant Sensor Network IoT system. Visualizes data from 13 environmental sensors with live updates, historical charting, and statistical analysis.

> **Part of the Plant Sensor Network ecosystem:** [Firmware (ESP32-S3)](https://github.com/zaeem7744/Plant-Sensor-Network) | [Backend API](https://github.com/zaeem7744/Plant-Sensor-Network-Backend) | **Web Dashboard**
